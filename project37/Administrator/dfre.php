<?php
    ...
    <div class="box3">
       ...
       $stulistaql="SELECT user_Id,name,email FROM user WHERE Type=1 AND user_Id not in (SELECT user_Id FROM course_follow WHERE course_Id='$couid')";
       ...
       /*if(isset($_POST["submit"])){
            foreach ($_POST["check"] as $value){
                $use=(int)$value;
                $quer="INSERT INTO course_follow (user_id,course_id) VALUES ('$use',1)";
