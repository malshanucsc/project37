...
<div id="content-list">
 <h3 style="margin-left: 5%;">Currently completed lessons</h3>
 <br> 
<?php
...
if ($result->num_rows > 0) {
    ...
    $result2 = $conn->query($sql2);
     ...
     <li ><a href="quizmainview.php?modID=<?php echo $mod_Id ?>" ><?php echo $row2['module_Title'] ?></a></li>
<br>
    <?php
  ...
  echo "<h3 style='margin-left: 5%;'> No Quizzes available</h3>";
}
