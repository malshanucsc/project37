...
<div id=breadcrumb style="float:bottom;position: relative;margin-top:0.5%;width:100%; border:solid 1px #E5E4E2; border-radius: 5px;">
        ...
        <li><a href="assignmentviewmain.php?asid=<?php echo $assign_ID; ?>">  <?php echo $assignmenttitle; ?>  > &nbsp </a></li>
        <li><a href="">Submissions   &nbsp </a></li>
...
<div id=submissions style="float:left;width:65%;left:5%;position:relative;margin-top:0.5%;background-color:#f3f9fe !important;border:solid 1px #E5E4E2; border-radius: 5px;">
<br>
<form  method="post" action="">
<button type="submit" style="margin-left:85%;" name="pubmarks">Publish Marks</button>
</form>
...
<?php
      ...
      <input type="hidden" name="s_id" value="<?php echo  $st_Id; ?>">
        ...
        <td>&nbsp&nbsp <input type="number" name="stmarks" max="100" min="0" size="4" maxlength="3" oninput="maxLengthCheck(this)" value="<?php echo $row2['marks']; ?>"> 
             <input style="margin-left:16%;" name="marks" type="submit" value="Add marks" ></td>
        </tr>
        </table>
