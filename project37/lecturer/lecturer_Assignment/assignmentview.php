...
<button type="button" class ="button btn-1" href = "javascript:void(0)" onclick = "document.getElementById('light3').style.display='block';document.getElementById('fade3').style.display='block'" >Change deadline</button>
...
echo"<script>window.location.href = 'assignmentviewmain.php?asid=$assign_ID '</script>";
}
...
<h4>
<a href="assign_submissions.php?assign_ID=<?php echo $aaid; ?>">View submissions</a>
</h4>



<div id="fade3" class="assmnt_black_overlay"></div>


<div id="light3" class="assmnt_white_content">
