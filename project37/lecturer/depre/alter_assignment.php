...
<body>
	...
	function insert($AsId,$title,$guide,$yy,$mm,$dd,$hr,$mi,$sec,$link){
      ...
      $sql="UPDATE assignment SET assignment_title='$title',link='$link',guide='$guide'WHERE assignment_id='{$AsId}'";
      $sql2="UPDATE do_assignment SET deadline='$datetime' WHERE assignment_id='{$AsId}'";
...
?>
		...
		<form enctype="multipart/form-data" action="alter_assignment.php" method="post">
    ...
    <input type="text" name="assignment_id"  size="50" > <br><br>
...
if(isset($_POST['u_button'])){
  ...
  if($_FILES["file"]["error"] >0){
	 ...
	 insert($_POST['assignment_id'],$_POST['assignment_title'],$_POST['guide'],$_POST['year'],$_POST['month'],$_POST['day'],$_POST['hour'],$_POST['min'],$_POST['sec'],$link);
