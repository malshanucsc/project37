...
<li><a href="student_Message/inbox.php" target="_parent" style="float: left; ">Inbox&nbsp<img height="" style="" src="../image/message2.png"><?php echo "(".$size.")";?><a></li>
<?php
}else{
  ?>
<li><a href="student_Message/inbox.php" target="_parent">Inbox</a></li>
<?php  
}
...
?>
<li style="background-color:#f3f9fe;width:100%;  font-weight: bold;list-style: none; ">Logged in as &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp   <?php echo $name; ?> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp : Student</li>
