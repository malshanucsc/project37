...
function openwin() {
    window.open("assignmentuploading_file.php ", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=80,left=500,width=400,height=330");
...
<div id=breadcrumb style="float:bottom;position: relative;margin-top:0.5%;width:100%; border:solid 1px #E5E4E2; border-radius: 5px;">
        ...
        <li><a href=""> Assignment &nbsp </a></li>
...
<div id=assignment style="float:left;width:65%;left:5%;position:relative;margin-top:0.5%;background-color:#f3f9fe !important;  border:solid 1px #E5E4E2; border-radius: 5px;">
<?php
