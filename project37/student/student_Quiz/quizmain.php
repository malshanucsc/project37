...
if ($result->num_rows > 0) {
  ...
  while($row= $result->fetch_assoc() ) {
    ...
    $result2 = $conn->query($sql2);
      ...
      if ($result2->num_rows > 0) {
        ...
        while($row2= $result2->fetch_assoc() ) {
         ...
         // if($row2['link']!=''){
            ?>
            <li><a  href= "qlist.php?modID=<?php echo $mo_ID ?>" target="_parent" > <?php echo $row2['module_Title'] ;?></a></li>
            <?php
    ...
    ?>
      <h3 style="margin-left:20%; color:red; "> <?php echo"No Quizzes published";?></h3><br>
    <?php
  }
?>
