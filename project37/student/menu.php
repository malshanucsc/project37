 ...
 <div style="text-align:center;">
    ...
    <!-- <section class="color-10"> -->
				<nav class="menu-btn">
					...
					<a href="student_Module/modules.php" data-hover="Lessons"><span>Lessons</span></a>
					<a href="student_Quiz/quiz.php" data-hover="Quizzes"><span>Quizzes</span></a>
					<a href="student_Assignment/assignment.php" data-hover="Assignments"><span>Assignments</span></a>
					<a href="student_Performance/performance.php" data-hover="Performance"><span>Performance</span></a>
				</nav>
			<!-- </section> -->
